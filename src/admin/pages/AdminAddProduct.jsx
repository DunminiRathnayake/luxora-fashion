...
function AdminAddProduct() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setSubmitError(err.message || "Failed to register product in database.");
    } finally {
  ...
  return (
    <div className="space-y-8 max-w-4xl">
      ...
      <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-10">
        ...
        {/* Right Column: Image Uploader and submission */}
            ...
            >
              ...
              {previewUrl ? (
                <>
                  ...
                  {/* Uploading progress cover screen overlay */}
                  {isUploading && (
